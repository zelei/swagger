...
/**
 * Reference to a decimal field
 */
@ApiModel(description = "Reference to a decimal field")
...
public class DecimalCustomFieldReference extends AbstractCustomFieldReference {
  ...
  public String toString() {
    ...
    sb.append("class DecimalCustomFieldReference {\n");
