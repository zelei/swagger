...
/**
 * Reference to a color field
 */
@ApiModel(description = "Reference to a color field")
...
public class ColorCustomFieldReference extends AbstractCustomFieldReference {
  ...
  public String toString() {
    ...
    sb.append("class ColorCustomFieldReference {\n");
