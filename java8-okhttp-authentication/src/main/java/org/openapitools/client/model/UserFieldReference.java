...
/**
 * Reference to a user field
 */
@ApiModel(description = "Reference to a user field")
...
public class UserFieldReference extends AbstractFieldReference {
  ...
  public String toString() {
    ...
    sb.append("class UserFieldReference {\n");
