...
/**
 * Reference to a date field
 */
@ApiModel(description = "Reference to a date field")
...
public class DateCustomFieldReference extends AbstractCustomFieldReference {
  ...
  public String toString() {
    ...
    sb.append("class DateCustomFieldReference {\n");
