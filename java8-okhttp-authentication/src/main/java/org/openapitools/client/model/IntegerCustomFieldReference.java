...
/**
 * Reference to a integer field
 */
@ApiModel(description = "Reference to a integer field")
...
public class IntegerCustomFieldReference extends AbstractCustomFieldReference {
  ...
  public String toString() {
    ...
    sb.append("class IntegerCustomFieldReference {\n");
