...
/**
 * Reference to a tracker field
 */
@ApiModel(description = "Reference to a tracker field")
...
public class TrackerFieldReference extends AbstractFieldReference {
  ...
  public String toString() {
    ...
    sb.append("class TrackerFieldReference {\n");
