...
/**
 * Reference to a duration field
 */
@ApiModel(description = "Reference to a duration field")
...
public class DurationCustomFieldReference extends AbstractCustomFieldReference {
  ...
  public String toString() {
    ...
    sb.append("class DurationCustomFieldReference {\n");
