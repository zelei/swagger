...
/**
 * Value of an user type choice field
 */
@ApiModel(description = "Value of an user type choice field")
...
public class UserChoiceFieldValue extends AbstractChoiceFieldValue {
  ...
  public String toString() {
    ...
    sb.append("class UserChoiceFieldValue {\n");
