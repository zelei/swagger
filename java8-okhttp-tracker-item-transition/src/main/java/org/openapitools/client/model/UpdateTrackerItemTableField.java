...
public class UpdateTrackerItemTableField {
  ...
  public UpdateTrackerItemTableField rows(List<TrackerItemTableRowFieldValueModel> rows) {
    this.rows = rows;
    return this;
  }

  public UpdateTrackerItemTableField addRowsItem(TrackerItemTableRowFieldValueModel rowsItem) {
    if (this.rows == null) {
