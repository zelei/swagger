...
/**
 * Reference to a SCM field
 */
@ApiModel(description = "Reference to a SCM field")
...
public class ScmFieldReference extends AbstractFieldReference {
  ...
  public String toString() {
    ...
    sb.append("class ScmFieldReference {\n");
