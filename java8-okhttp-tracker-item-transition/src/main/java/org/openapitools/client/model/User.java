...
public class User {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, uri, name, type, firstName, lastName, email, title, company, address, zip, city, state, country, dateFormat, timeZone, language, phone, skills, registryDate, status);
  }
