...
/**
 * Value of an group field
 */
@ApiModel(description = "Value of an group field")
...
public class GroupFieldValueModel extends AssigneeFieldValueModel {
  ...
  public String toString() {
    ...
    sb.append("class GroupFieldValueModel {\n");
