...
/**
 * Reference to a langauge field
 */
@ApiModel(description = "Reference to a langauge field")
...
public class LanguageCustomFieldReference extends AbstractCustomFieldReference {
  ...
  public String toString() {
    ...
    sb.append("class LanguageCustomFieldReference {\n");
