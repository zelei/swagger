...
/**
 * Reference to a text field
 */
@ApiModel(description = "Reference to a text field")
...
public class TextCustomFieldReference extends AbstractCustomFieldReference {
  ...
  public String toString() {
    ...
    sb.append("class TextCustomFieldReference {\n");
